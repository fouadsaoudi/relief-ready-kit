...
export function QuoteForm({ defaultCategory = "", onSuccess }: QuoteFormProps) {
  ...
  return (
    <form onSubmit={onSubmit} className="grid gap-5 py-4">
      ...
      <Button type="submit" size="lg" className="mt-2 w-full sm:w-auto justify-self-start">
        Submit Request
      </Button>
    </form>
  );
...
function Field({
  ...
  return (
    <div className="grid gap-2">
      ...
      <Input id={name} name={name} type={type} placeholder={placeholder} className="h-9 text-sm" />
